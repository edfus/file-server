"use strict";
const { stat, createWriteStream, createReadStream, readdir, existsSync } = require("fs");
const { extname, basename, join, normalize, dirname } = require("path");
const { pipeline } = require("stream");
const EventEmitter = require("events");
const { createServer } = require("http");

const mime = require("./env/mime.js");
const pathMap = require("./env/path-map.js");
